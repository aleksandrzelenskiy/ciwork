...
import NotificationModel, { type NotificationDoc } from '@/server/models/NotificationModel';
import type {
    NotificationDTO,
    NotificationKind,
    NotificationStatus,
...
const FRONTEND_FALLBACK = 'https://ws.ciwork.pro';
...
const toAbsoluteLink = (link?: string): string | undefined => {
    ...
    const base = normalizeBaseUrl(FRONTEND_URL_VALUE);
