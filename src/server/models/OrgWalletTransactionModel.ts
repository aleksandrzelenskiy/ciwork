...
export type OrgWalletTxSource = 'manual' | 'storage_overage' | 'subscription' | 'storage_package' | 'publication';
...
const OrgWalletTransactionSchema = new Schema<OrgWalletTransaction>(
    {
        ...
        source: { type: String, enum: ['manual', 'storage_overage', 'subscription', 'storage_package', 'publication'], required: true },
