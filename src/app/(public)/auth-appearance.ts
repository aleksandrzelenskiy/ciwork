...
export const authAppearance = {
    ...
    elements: {
        ...
        card: 'mx-auto w-full max-w-md rounded-t-3xl rounded-b-none border border-white/30 bg-white/80 px-8 py-8 shadow-2xl backdrop-blur',
        ...
        formButtonPrimary:
            'w-full rounded-xl bg-emerald-700 px-4 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-emerald-800',
