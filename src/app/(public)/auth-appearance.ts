...
export const authAppearance = {
    ...
    elements: {
        ...
        card: 'mx-auto w-full max-w-lg rounded-t-3xl rounded-b-none border border-white/60 bg-gradient-to-br from-white/80 via-blue-50/60 to-violet-100/45 px-8 py-8 shadow-2xl backdrop-blur-2xl',
        ...
        formFieldInput:
            'w-full rounded-xl border border-white/70 bg-white/80 text-slate-900 shadow-sm backdrop-blur-md focus:border-blue-500 focus:ring-blue-500',
        formButtonPrimary:
        ...
        footerActionText: 'text-sm font-medium text-slate-800',
